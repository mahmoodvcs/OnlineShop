...
namespace MahtaKala.Messages
{
    public static partial class Messages
    {
        public static class Order
        {
            ...
            public const string DeliveredOTPMessage = "سایت من کالا: کالای شما ارسال شد. کد دریافت کالا: {0}. در هنگام تحویل، این کد را به پیک ارائه دهید";
            public const string ProductDoesNotExistInStore ="کالای {0} در انبار موجود نیست";
            public const string OrderPaymentSuccessMessage = "سایت من کالا: پرداخت انجام شد. کد تحویل: {0}. ارائه کد فوق هنگام تحویل کالای خریداری شده الزامی است. تاریخ تخمینی ارسال کالا: {1}";
