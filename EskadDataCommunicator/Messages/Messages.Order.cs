...
namespace MahtaKala.Messages
{
    public static partial class Messages
    {
        public static class Order
        {
            ...
            public const string OrderPaymentSuccessMessage = "مهتاکالا: پرداخت انجام شد. کد تحویل: {0}. برای حفاظت از کالای شما، تحویل کالا بدون ارائه این کد امکان پذیر نیست. زمان تحویل: {1} ساعت 18 الی 21";
